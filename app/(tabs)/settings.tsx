		...
		>
						...
						<View style={styles.twoColumnRow}>
							...
							<View style={[styles.editFormGroup, { flex: 1, marginLeft: 8 }]}>
								...
								<View style={[styles.genderPicker, { borderColor: colors.border }]}>
									<TouchableOpacity
										style={[styles.genderOption, editedProfile.gender === "male" && { backgroundColor: colors.accent }]}
			...
			<View style={[styles.section, { backgroundColor: colors.bgSecondary, borderColor: colors.border }]}>
				...
				>
					...
					<View style={[styles.toggleSwitch, { backgroundColor: notificationsEnabled ? colors.green : colors.border }]}>
						<View
							style={[
								styles.toggleDot,
								{
				...
				>
					...
					<View style={[styles.toggleSwitch, { backgroundColor: mealRemindersEnabled ? colors.green : colors.border }]}>
						<View
							style={[
								styles.toggleDot,
								{
